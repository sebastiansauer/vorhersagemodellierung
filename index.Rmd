...
render_course_outline(course_dates_file, content_file, small_table = TRUE)
```
...
descriptors <- c("KW", "Kurswoche", "Datum_Beginn", "Titel", "Lernziele", "Vorbereitung", "Aufgaben", "Vertiefung", "Hinweise", "Skript")
