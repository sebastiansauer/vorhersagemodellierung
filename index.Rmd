...
- Weiterführende Literatur (nicht zwingend nötig, aber ggf. nützlich): `r RefManageR::Citet(bib, "wickham_r_2018")` (abgekürzt als *R4DS*) und `r RefManageR::Citet(bib, "cetinkaya-rundel_introduction_2021")` (abgekürzt als *IMS*).
